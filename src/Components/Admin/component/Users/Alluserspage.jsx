        ...
        <div style={{ background: "linear-gradient(135deg,#0b1a2e 0%,#1a56db 100%)", padding: "28px 28px 22px", position: "relative", minHeight: 100 }}>
          ...
          {user && !loading && (
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div style={{ width: 64, height: 64, borderRadius: "50%", background: user.avatarColor, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, fontWeight: 800, color: "#fff", border: "3px solid rgba(255,255,255,0.3)", flexShrink: 0 }}>{user.avatar}</div>
              <div>
...
export default function AllUsersPage() {
  ...
  /* Update row locally after PATCH */
    ...
    <div style={{ padding: "32px 40px", maxWidth: 1000, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 28 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 800, color: "#0b1a2e", margin: 0, letterSpacing: "-0.5px" }}>All Users</h1>
        </div>
      ...
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 20, overflow: "hidden", boxShadow: "0 1px 8px rgba(0,0,0,0.05)" }}>
          ...
          paginated.map((user, i) => (
            <div key={user.id}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 40, height: 40, borderRadius: "50%", background: user.avatarColor, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 800, color: "#fff", flexShrink: 0, boxShadow: "0 2px 8px rgba(0,0,0,0.12)" }}>{user.avatar}</div>
                <div>
        ...
        {totalPages > 1 && (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 24px", borderTop: "1px solid #f3f4f6", background: "#fafafa" }}>
            <span style={{ fontSize: 12, color: "#9ca3af", fontWeight: 500 }}>Showing {(page - 1) * PAGE_SIZE + 1}–{Math.min(page * PAGE_SIZE, filtered.length)} of {filtered.length} users</span>

...
/* ─── MAIN DASHBOARD ─────────────────────────────────────────────────────────── */
export default function UserDashboard({ adminEmbedded = false }) {
    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "Inter, sans-serif", display: "flex", overflow: "hidden", width: "100%", maxWidth: "100vw", boxSizing: "border-box" }}>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* Main content offset — suppressed when embedded in admin panel */
        .dash-main { margin-left: 0 !important; }
        @media (min-width: 768px) { .dash-main { margin-left: ${adminEmbedded ? "0" : "220px"} !important; } }
      ...
      {!adminEmbedded && <Sidebar mobileOpen={mobileOpen} setMobileOpen={setMobileOpen} />}
      ...
      <main className="dash-main" style={{ flex: 1, minHeight: "100vh", minWidth: 0, maxWidth: "100%", width: "100%", boxSizing: "border-box", overflowX: "hidden" }}>
        ...
        {/* Mobile top bar — hidden when embedded in admin panel */}
        {!adminEmbedded && (

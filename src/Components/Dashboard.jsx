    ...
    <section id="how-it-works" className="py-16 sm:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-gray-400 mt-2 text-sm sm:text-base">Use Nestfind in four simple steps</p>
        </div>
  ...
  return (
    <div className="font-sans bg-white text-gray-900 overflow-x-hidden">
      ...
      <section id="about" className="py-12 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <p className="text-gray-500 text-base sm:text-lg mb-6">We connect buyers, sellers, and verified agents to make property transactions seamless, transparent, and secure across Nigeria.</p>
      ...
      <section id="features" className="py-12 sm:py-20 bg-[#0a1628] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white">Core Features</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              <div key={i} className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl p-5 sm:p-7 hover:bg-white/20 transition-all group">
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900">Who is it for</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {[
              ...
              <div key={role} className="rounded-3xl overflow-hidden shadow-xl border border-gray-100 flex flex-col sm:flex-row">
                <img src={img} alt={role} className="w-full sm:w-48 md:w-56 h-48 sm:h-auto object-cover"/>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 sm:mb-10">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900">What People Say About Nestfind</h2>
            </div>
      ...
      <section id="contact" className="py-12 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 md:gap-12">
          <div>
            <div className="text-blue-500 font-semibold text-sm uppercase tracking-wider mb-3">Support</div>
            <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mb-6 sm:mb-8">Frequently Asked Questions</h2>
            <div className="space-y-3">
              {FAQS.map((f,i) => (
                <div key={i} className="bg-white rounded-xl border border-gray-100 overflow-hidden">
                  <button onClick={() => setOpenFaq(openFaq===i?null:i)}
                    className="w-full flex items-center justify-between px-4 sm:px-5 py-4 text-left font-semibold text-gray-900 text-sm hover:bg-gray-50 transition-colors">
                    {f.q}<Plus size={18} className={`text-gray-400 transition-transform shrink-0 ml-2 ${openFaq===i ? "rotate-45" : ""}`}/>
                  </button>
                  {openFaq===i && <div className="px-4 sm:px-5 pb-4 text-gray-500 text-sm">{f.a}</div>}
                </div>
              ))}
            </div>
            <div className="mt-8 bg-blue-50 rounded-2xl p-5 sm:p-6 flex flex-col items-center text-center gap-3">
          ...
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mb-6 sm:mb-8">Contact Us</h2>
      ...
      {/* ── CTA ── */}
      <section className="py-12 sm:py-16 bg-blue-700">

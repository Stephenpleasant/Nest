...
/* ── Payment Success Modal (same design as the original inspection confirmation) ── */
const PaymentSuccessModal = ({ booking, onClose }) => (
  <div style={{
    position:"fixed",inset:0,zIndex:1000,background:"rgba(7,20,34,0.65)",
    backdropFilter:"blur(4px)",display:"flex",alignItems:"center",
    justifyContent:"center",padding:16,
  }}>
    <style>{`@keyframes fadeUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}`}</style>
    <div style={{
      background:WHITE,borderRadius:22,maxWidth:520,width:"100%",
      ...
      <div style={{ padding:"24px 28px" }}>
        ...
        <div style={{ textAlign:"center",marginBottom:20 }}>
          ...
          <h4 style={{ fontFamily:"Poppins,sans-serif",color:NAVY,fontSize:"1.1rem",marginBottom:8,margin:"0 0 8px" }}>Inspection Booked!</h4>
          {booking && (
        ...
        <div style={{ background:"#f0f9ff",border:"1px solid #bae6fd",borderRadius:12,padding:"14px 16px",marginBottom:18,display:"flex",alignItems:"flex-start",gap:12 }}>
          ...
          <div>
            ...
            <p style={{ fontSize:13,color:"#0369a1",margin:0 }}>
              Sent to <strong>{booking?.userEmail || "your registered email"}</strong>. Check your inbox (and spam folder).
            </p>
          </div>
        </div>
        ...
        {booking && (
          <div style={{ background:"#f8fafc",borderRadius:12,padding:"14px 16px",marginBottom:20 }}>
            {[
              ...
              ["Booked By",booking.userName || "You"],
...
const MyBookings = () => {
  ...
  return (
    <>
      ...
      {/* Payment success modal — shown when Paystack redirects back */}
      {paymentSuccess && (
        <PaymentSuccessModal

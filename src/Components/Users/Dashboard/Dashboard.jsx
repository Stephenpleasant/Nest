    ...
    <Link to={`/properties/${property._id}`} style={{ textDecoration: "none" }}>
      ...
      >
        ...
        <div style={{ padding: "18px 20px 20px", flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
          <h3 style={{ fontSize: 15.5, fontWeight: 700, color: "#0b1a2e", margin: 0, fontFamily: "Poppins, sans-serif", lineHeight: 1.3, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
            {property.title}
          </h3>
          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
            <MapPin size={13} color="#9ca3af" />
            <span style={{ fontSize: 12.5, color: "#6b7280", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{property.location}</span>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ textAlign: "right" }}>
              <div style={{ fontSize: 16, fontWeight: 800, color: "#1a56db", fontFamily: "Poppins, sans-serif" }}>{formatPrice(property.price)}</div>
              <div style={{ fontSize: 10.5, color: "#9ca3af" }}>listing price</div>
              {property.inspectionFee > 0 && (
                <div style={{ fontSize: 10.5, color: "#6b7280", marginTop: 2 }}>Inspection: {formatPrice(property.inspectionFee)}</div>
              )}
            </div>
          </div>
          <button
            style={{ width: "100%", padding: "10px", border: "none", borderRadius: 10, background: "#0b1a2e", color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", transition: "background 0.2s", fontFamily: "Poppins, sans-serif" }}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "Inter, sans-serif", display: "flex" }}>
      ...
      <style>{`
        ...
        /* Hero height */
        .dash-hero { height: 280px !important; }
        @media (min-width: 480px) { .dash-hero { height: 320px !important; } }
        @media (min-width: 768px) { .dash-hero { height: 360px !important; } }

        /* Hero title */
        .dash-hero-title { font-size: 1.5rem !important; }
        @media (min-width: 480px) { .dash-hero-title { font-size: 1.9rem !important; } }
        @media (min-width: 768px) { .dash-hero-title { font-size: 2.2rem !important; } }

        /* Search bar stacks on mobile */
        .dash-search-bar { flex-direction: column !important; border-radius: 14px !important; }
        @media (min-width: 580px) { .dash-search-bar { flex-direction: row !important; } }

        .dash-search-bar .dash-search-divider { border-right: none !important; border-bottom: 1px solid #e5e7eb !important; }
        @media (min-width: 580px) { .dash-search-bar .dash-search-divider { border-right: 1px solid #e5e7eb !important; border-bottom: none !important; } }

        .dash-search-btn { border-radius: 0 0 14px 14px !important; }
        @media (min-width: 580px) { .dash-search-btn { border-radius: 0 14px 14px 0 !important; } }

        /* Filter pills wrap */
        .dash-pills { flex-wrap: wrap !important; gap: 8px !important; }

        /* Content padding */
        .dash-content { padding: 20px 16px 60px !important; }
        ...
        /* Pagination wrap */
        .dash-pagination { flex-wrap: wrap !important; gap: 6px !important; }
      ...
      <main className="dash-main" style={{ flex: 1, minHeight: "100vh", minWidth: 0, boxSizing: "border-box" }}>
        ...
        <div className="dash-hero" style={{
          ...
          <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "0 20px", width: "100%", maxWidth: 700 }}>
            <p style={{ fontSize: 11, fontWeight: 700, color: "#93c5fd", letterSpacing: "2px", textTransform: "uppercase", marginBottom: 8 }}>
              WELCOME TO NESTFIND
            </p>
            <h1 className="dash-hero-title" style={{ fontFamily: "Poppins, sans-serif", fontWeight: 800, color: "#fff", margin: "0 0 8px", lineHeight: 1.2 }}>
              Find Your Next Home
            </h1>
            <p style={{ color: "rgba(255,255,255,0.8)", fontSize: 13, marginBottom: 20 }}>
              Browse available properties across Lagos and book an inspection in minutes.
            </p>

            {/* Search bar */}
            <div className="dash-search-bar" style={{ display: "flex", alignItems: "stretch", background: "#fff", borderRadius: 14, overflow: "hidden", boxShadow: "0 8px 32px rgba(0,0,0,0.25)", maxWidth: 580, margin: "0 auto 16px" }}>
              {/* Search input */}
              <div style={{ position: "relative", flex: 2 }} className="dash-search-divider">
                ...
                <input
                  ...
                  style={{ width: "100%", padding: "14px 14px 14px 34px", border: "none", outline: "none", background: "transparent", fontSize: 13.5, color: "#374151", fontFamily: "inherit", boxSizing: "border-box" }}
                />
              </div>
              {/* City */}
              <div style={{ position: "relative", flex: 1 }} className="dash-search-divider">
                ...
                <select value={cityFilter} onChange={e => { setCityFilter(e.target.value); setCurrentPage(1); }}
                  style={{ width: "100%", padding: "14px 28px 14px 32px", border: "none", outline: "none", background: "transparent", fontSize: 13, color: "#374151", fontFamily: "inherit", appearance: "none", cursor: "pointer" }}>
              ...
              <div style={{ position: "relative", flex: 1 }} className="dash-search-divider">
                ...
                <select value={typeFilter} onChange={e => { setTypeFilter(e.target.value); setCurrentPage(1); }}
                  style={{ width: "100%", padding: "14px 28px 14px 30px", border: "none", outline: "none", background: "transparent", fontSize: 13, color: "#374151", fontFamily: "inherit", appearance: "none", cursor: "pointer" }}>
              ...
              <button className="dash-search-btn"
                style={{ padding: "14px 24px", background: "#1a56db", color: "#fff", border: "none", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "Poppins, sans-serif", whiteSpace: "nowrap", transition: "background 0.18s" }}
              ...
              {[{ val: "all", label: "All Status" }, { val: "rent", label: "For Rent" }, { val: "sale", label: "For Sale" }].map(({ val, label }) => (
                <button key={val} onClick={() => { setFilter(val); setCurrentPage(1); }}
                  style={{
                    ...
                    fontSize: 13, fontWeight: 600, cursor: "pointer", transition: "all 0.18s", fontFamily: "inherit",
                  }}>
                  {label}
                </button>
              ))}
        ...
        <div className="dash-content">
          ...
          {loading ? (
            ...
            <div className="prop-grid" style={{ display: "grid", gap: 22, marginBottom: 36 }}>
          ...
          {totalPages > 1 && (
            <div className="dash-pagination" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
              <button onClick={() => setCurrentPage(p => Math.max(1, p - 1))} disabled={currentPage === 1}
                style={{ display: "flex", alignItems: "center", gap: 6, padding: "9px 16px", borderRadius: 10, border: "1.5px solid #e5e7eb", background: "#fff", fontSize: 13, fontWeight: 600, cursor: currentPage === 1 ? "not-allowed" : "pointer", opacity: currentPage === 1 ? 0.4 : 1, color: "#374151", fontFamily: "inherit" }}>
                <ChevronLeft size={15} /> Prev
              </button>
              {Array.from({ length: totalPages }, (_, i) => (
                <button key={i} onClick={() => setCurrentPage(i + 1)}
                  style={{ width: 38, height: 38, borderRadius: 10, border: "1.5px solid", borderColor: currentPage === i + 1 ? "#1a56db" : "#e5e7eb", background: currentPage === i + 1 ? "#1a56db" : "#fff", color: currentPage === i + 1 ? "#fff" : "#374151", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>
                  {i + 1}
                </button>
              ))}
              <button onClick={() => setCurrentPage(p => Math.min(totalPages, p + 1))} disabled={currentPage === totalPages}
                style={{ display: "flex", alignItems: "center", gap: 6, padding: "9px 16px", borderRadius: 10, border: "1.5px solid #e5e7eb", background: "#fff", fontSize: 13, fontWeight: 600, cursor: currentPage === totalPages ? "not-allowed" : "pointer", opacity: currentPage === totalPages ? 0.4 : 1, color: "#374151", fontFamily: "inherit" }}>

  ...
  export default function FeaturesSection({ data, onChange }) {
    ...
    return (
      <div className="bg-white rounded-xl border border-gray-200 p-6 mb-5">
        ...
        <div className="grid grid-cols-5 gap-x-4 gap-y-3 mb-5">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <input
            ...
            className="flex-1 max-w-xs border-0 border-b border-gray-300 pb-1 text-sm text-gray-900 placeholder-gray-400 outline-none focus:border-blue-500 transition bg-transparent"
          />
        </div>
      </div>
    );

    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6 mb-5">
      ...
      {activeTab === "property" && (
        <>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <SelectField  label="Property Size Postfix" name="propertySizePostfix" value={data.propertySizePostfix} onChange={onChange} options={SIZE_POSTFIX} />
      ...
      {activeTab === "lands" && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <SelectField  label="Land Size Postfix" name="landSizePostfix" value={data.landSizePostfix} onChange={onChange} options={SIZE_POSTFIX} />
        </div>
      )}
    </div>
  );
